...
Revision ID: 6655c8f0dad7
Revises: 
Create Date: 2024-11-02 23:43:39.586714
...
def upgrade() -> None:
    ...
    sa.CheckConstraint('expiration_date IS NULL OR expiration_date >= date_of_creation', name='check_expiration_date'),
